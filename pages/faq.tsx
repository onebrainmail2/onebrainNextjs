    ...
    return(
        <HomepageLayout>
          ...
          <div className="col-lg-12">
            ...
            <CollapsibleText title="What if you’re missing an app I use?" text="No worries! <a>Join our waitlist</a> to request or select the workspace apps you use. Our plan is to support all apps big or small that our customers want to use. If you are the owner of a new app and you want OneBrain integrated to it, you can fill this form out here." />
            
            <CollapsibleText title="What if you’re missing an app I use?" text="No worries! <a>Join our waitlist</a> to request or select the workspace apps you use. Our plan is to support all apps big or small that our customers want to use. If you are the owner of a new app and you want OneBrain integrated to it, you can fill this form out here." />
            <CollapsibleText title="What if you’re missing an app I use?" text="">
            <p className='text-left'>
              No worries! <Link href="https://tally.so/r/mJqjgd">Join our waitlist</Link> to request or select the workspace apps you use. Our plan is to support all apps big or small that our customers want to use. If you are the owner of a new app and you want OneBrain integrated to it, you can fill this form out here.
            </p>
            </CollapsibleText>
